...
public class XuLyDonFunctions {
	...
	/*
	 * public XuLyDon chuyenVienChuyenDon(XuLyDon xuLyDon, XuLyDon
	 * xuLyDonHienTai, Long congChucId, String note) { HuongXuLyXLDEnum
	 * huongXuLyXLD = xuLyDon.getHuongXuLy(); // huongXuLy note = note +
	 * huongXuLyXLD.getText().toLowerCase().trim() + " ";
	 * 
	 ...
	 * xuLyDonHienTai.setyKienXuLy(xuLyDon.getyKienXuLy()); XuLyDon
	 * xuLyDonTiepTheo = new XuLyDon();
	 * 
	 ...
	 * Utils.save(xuLyDonRepo, xuLyDonHienTai, congChucId); } else if
	 ...
	 * } xuLyDonHienTai.setGhiChu(note); Utils.save(xuLyDonRepo, xuLyDonHienTai,
	 * congChucId); } else if (huongXuLyXLD.equals(HuongXuLyXLDEnum.CHUYEN_DON))
	 * {
	 * 
	 * note = note + VaiTroEnum.VAN_THU.getText().toLowerCase().trim() + " " +
	 * xuLyDon.getPhongBanXuLy().getTen().toLowerCase().trim();
	 ...
	 * xuLyDonTiepTheo.setCoQuanChuyenDon(xuLyDonHienTai.getCoQuanChuyenDon());
	 * } xuLyDonHienTai.setGhiChu(note); Utils.save(xuLyDonRepo, xuLyDonHienTai,
	 * congChucId); // return Utils.doSave(repo, xuLyDonTiepTheo, congChucId,
	...
	/*
	 * public XuLyDon vanThuTraLaiDonKhongDungThamQuyen(XuLyDon xuLyDon, String
	 * note, Long congChucId) { Long donId = xuLyDon.getDon().getId(); XuLyDon
	 * xuLyDonHienTai = xuLyDonService.predFindCurrent(xuLyDonRepo, donId);
	 * XuLyDon xuLyDonTiepTheo = new XuLyDon();
	 * 
	 * xuLyDonHienTai.setCongChuc(congChucRepo.findOne(congChucId));
	 * xuLyDonHienTai.setTrangThaiDon(TrangThaiDonEnum.DA_XU_LY); Don don =
	 ...
	 * don.setThamQuyenGiaiQuyet(xuLyDonHienTai.getThamQuyenGiaiQuyet());
	 * Utils.save(donRepo, don, congChucId); Utils.save(xuLyDonRepo,
	 * xuLyDonHienTai, congChucId);
	 * 
	 * return xuLyDonHienTai; }
	 */
