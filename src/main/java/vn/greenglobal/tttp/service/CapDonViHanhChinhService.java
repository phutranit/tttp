...
public class CapDonViHanhChinhService {
	...
	public Predicate predicateFindAll(String ten) {
		...
		if (ten != null && !"".equals(ten)) {
			predAll = predAll.and(QCapDonViHanhChinh.capDonViHanhChinh.ten.containsIgnoreCase(ten).or(QCapDonViHanhChinh.capDonViHanhChinh.ma.containsIgnoreCase(ten)));
		}		
		return predAll;
	}
	
	public Predicate predicateFindOne(Long id) {
		return QCapDonViHanhChinh.capDonViHanhChinh.daXoa.eq(false)
