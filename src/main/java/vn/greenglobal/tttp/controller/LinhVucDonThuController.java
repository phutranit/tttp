...
public class LinhVucDonThuController extends TttpController<LinhVucDonThu> {
	...
	public @ResponseBody Object getAllList(@RequestHeader(value = "Authorization", required = true) String authorization,
		...
		try {
			...
			Page<LinhVucDonThu> page = repo.findAll(linhVucDonThuService.predicateFindAll(), pageable);
	...
	@SuppressWarnings({ "unchecked", "rawtypes" })
	@RequestMapping(method = RequestMethod.GET, value = "/linhVucDonThus/hienThiTree")
	@ApiOperation(value = "Lấy danh sách Lĩnh Vực Đơn Thư", position = 1, produces = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody Object getListTree(@RequestHeader(value = "Authorization", required = true) String authorization,
	...
	@ApiOperation(value = "Lấy danh sách Lĩnh Vực Đơn Thư", position = 1, produces = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody Object getListLinhVucDonThuTHeoLoaiDon(
	...
	public ResponseEntity<Object> delete(@RequestHeader(value = "Authorization", required = true) String authorization,
		...
		try {
			...
			linhVucDonThuService.save(linhVucDonThu,
