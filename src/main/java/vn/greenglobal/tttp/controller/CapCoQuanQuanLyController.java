...
public class CapCoQuanQuanLyController extends TttpController<CapCoQuanQuanLy> {
	...
	@RequestMapping(method = RequestMethod.GET, value = "/capCoQuanQuanLys/thongKeBaoCao")
	@ApiOperation(value = "Lấy danh sách Cấp Cơ Quan Quản Lý", position = 1, produces = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody Object getCan(@RequestHeader(value = "Authorization", required = true) String authorization,
	...
	@ApiOperation(value = "Lấy danh sách Cấp Cơ Quan Quản Lý", position = 1, produces = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody Object getCapCoQuanDaGiaiQuyets(
