...
public class ThongKeBaoCaoController extends TttpController<Don> {
	...
	public @ResponseBody ResponseEntity<Object> getTongHopKetQuaTiepCongDan(@RequestHeader(value = "Authorization", required = true) String authorization,
		...
		try {
			...
			for (CoQuanQuanLy cq : donVis) {
				...
				//linhVucHanhChinh - 24
				mapMaSo.put("linhVucTuPhapDonToCao", thongKeBaoCaoTongHopKQTCDService.getTongSoVuViecTiepCongDanDonToCaoLinhVucHanhChinhVaTuPhap(predAllDSTCDDonVi, linhVucTuPhap));
	...
	public @ResponseBody ResponseEntity<Object> getTongHopKetQuaGiaiQuyetDonKhieuNai(@RequestHeader(value = "Authorization", required = true) String authorization,
		...
		try {
			...
			for (CoQuanQuanLy cq : donVis) {
				...
				Long donTonKyTruocChuyenSang = loaiKyEnum.equals(ThongKeBaoCaoLoaiKyEnum.THEO_NGAY) && StringUtils.isBlank(tuNgay) ? 
	...
	public void exportExcel(HttpServletResponse response,
		...
		try {			
			...
			idLinhVucHanhChinhDonKhieuNaiVeChinhSachs.add(3L);
			idLinhVucHanhChinhDonKhieuNaiVeChinhSachs.add(28L);
