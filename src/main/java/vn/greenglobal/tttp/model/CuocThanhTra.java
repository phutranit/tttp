...
public class CuocThanhTra extends Model<CuocThanhTra> {
	...
	public Map<String, Object> getKeHoachThanhTraInfo() {
		if (getKeHoachThanhTra() != null) {
			...
			map.put("chucNangKeHoachThanhTraInfo", getKeHoachThanhTra().getChucNangKeHoachThanhTraInfo());
	...
	@Transient
	@ApiModelProperty(hidden = true)
	public List<DoiTuongThanhTra> getListDoiTuongThanhTra() {
		return getDoiTuongThanhTras();
	}
